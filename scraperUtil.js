...
var ScaperUtil = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.saveHtml(filename, rawHtml, "raw")];
                    case 2:
    ...
    ScaperUtil.prototype.saveHtml = function (fileName, html, type) {
        return __awaiter(this, void 0, void 0, function () {
            var fileNameWithoutFileType, fullFilePath;
            return __generator(this, function (_a) {
                fileNameWithoutFileType = fileName.split(".")[0];
                fullFilePath = "".concat(__dirname, "/").concat(fileNameWithoutFileType, "/").concat(type + "-" + fileName.substring(1));
                ...
                fs.writeFile(fullFilePath, html, function (err) {
                    if (err)
                        throw err;
                    return "File has been saved at ".concat(fileName);
                });
                return [2 /*return*/];
            });
        });
